...
//     <ul className="absolute left-0 hidden group-hover:block bg-white shadow-lg py-2 mt-1 min-w-[200px]">
//       {items.map((subItem) => (
//         <li key={subItem.id}>
//           <Link
//             href={subItem.path || "#"}
...
//                       key={subItem.id}
//                       href={subItem.path || "#"}
//                       className="block px-3 py-2 text-sm font-medium text-gray-500 hover:text-blue-600 hover:bg-gray-50"
//                     >
//                       {subItem.title}
//                     </Link>
//                   ))}
